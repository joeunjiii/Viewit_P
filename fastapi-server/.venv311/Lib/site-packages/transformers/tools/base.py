...
class Tool:
    ...
    def save(self, output_dir):
        ...
        - a `requirements.txt.txt` containing the names of the module used by your tool (as detected when inspecting its
          code)
        ...
        requirements_file = os.path.join(output_dir, "requirements.txt.txt")
        imports = []
