...
def require_version(requirement: str, hint: Optional[str] = None) -> None:
    ...
    Args:
        ...
        hint (`str`, *optional*): what suggestion to print in case of requirements.txt not being met
    ...
    if re.match(r"^[\w_\-\d]+$", requirement):
        ...
        want_range = want_full.split(",")  # there could be multiple requirements.txt
        wanted = {}
        for w in want_range:
